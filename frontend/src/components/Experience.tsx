  ...
  const template = (
    ...
    const structure = arr.map((x, i) => (
      <Link
        to={x.link}
        key={i}
        className='text-awobe-black flex flex-col py-[28px] px-[10px] items-center gap-[5px] rounded-[8px] border border-awobe-black w-[90%] hover:bg-awobe-black hover:text-awobe max-tablet:bg-awobe max-tablet:hover:text-awobe-black'>
